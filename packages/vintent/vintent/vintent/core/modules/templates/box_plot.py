...
@dataclass
class BoxPlotShell:
    """Box Plot shell implementation for visualizing distribution of quantitative data."""
    ...
    required: EncodingMapType = field(default_factory=lambda: {"x": {"type": "nominal"}, "y": {"type": "quantitative"}})
